...
public:
	 ...
	 */
	void CalculateClipPlanes(SVector4Df& vLeft, SVector4Df& vRight, SVector4Df& vBottom, SVector4Df& vTop, SVector4Df& vNear, SVector4Df& vFar);
...
protected:
	 ...
	 * @param bLeftHanded: A boolean indicating whether to use a left-handed coordinate system if true.
	 */
	void InitRoatationX(const float fRotX, const bool bLeftHanded = false);
	 ...
	 * @param bLeftHanded: A boolean indicating whether to use a left-handed coordinate system if true.
	 */
	void InitRoatationY(const float fRotY, const bool bLeftHanded = false);
	 ...
	 * @param bLeftHanded: A boolean indicating whether to use a left-handed coordinate system if true.
	 */
	void InitRoatationZ(const float fRotZ, const bool bLeftHanded = false);
};
